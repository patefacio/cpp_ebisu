...
The purpose is to make the paths those variables refer to available to code.'''
      ...
      ..usesStreamers = true
      ..members = [
        member('environment')..type = 'Environment_map_t'..isByRef = true..access = ro,
        member('path_variable_map')..type = 'Path_variable_map_t'..isByRef = true..access = ro,
      ],
    ]
    ..testScenarios = [
      testScenario('read environment'),
    ],
  ];
