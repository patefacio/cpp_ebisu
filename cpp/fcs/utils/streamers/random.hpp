...
namespace streamers {
  ...
  template< class T >
  Random_source &
  operator>>(Random_source &source, T & t);

  template< > Random_source & operator>>(Random_source &source, int & t) {
    generate_integer(t, source.engine);
    return source;
  }
  template< > Random_source & operator>>(Random_source &source, long & t) {
    generate_integer(t, source.engine);
    return source;
  }
  template< > Random_source & operator>>(Random_source &source, long long & t) {
    generate_integer(t, source.engine);
    return source;
  }

  template< > Random_source & operator>>(Random_source &source, float & t) {
    generate_integer(t, source.engine);
    return source;
  }
  template< > Random_source & operator>>(Random_source &source, double & t) {
    generate_integer(t, source.engine);
    return source;
  }
  template< > Random_source & operator>>(Random_source &source, uint8_t & t) {
    generate_integer(t, source.engine);
    return source;
  }
  template< > Random_source & operator>>(Random_source &source, uint16_t & t) {
    generate_integer(t, source.engine);
    return source;
  }
  template< > Random_source & operator>>(Random_source &source, uint32_t & t) {
    generate_integer(t, source.engine);
    return source;
  }
  template< > Random_source & operator>>(Random_source &source, uint64_t & t) {
    generate_integer(t, source.engine);
    return source;
  }
  ...
  template< >
  Random_source &
  operator>>(Random_source &source, char & c) {
  ...
  template< >
  Random_source &
  operator>>(Random_source &source, std::string & s) {
  ...
  Random_source &
  generate_push_back_data(Random_source &source,
