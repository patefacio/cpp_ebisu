#ifndef __EBISU_UTILS_BLOCK_INDENTER_HPP__
#define __EBISU_UTILS_BLOCK_INDENTER_HPP__
...
class Block_indenter {
 public:
  ...
  Block_indenter() { Block_current_indent::instance().increment_indent(); }

  ~Block_indenter() { Block_current_indent::instance().decrement_indent(); }
...
#endif  // __EBISU_UTILS_BLOCK_INDENTER_HPP__
